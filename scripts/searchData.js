...
{"l":"api/meow/prelude$.html","n":"Semigroup_String","t":"given Semigroup_String: given_Semigroup_String","d":"meow/prelude$"},
{"l":"api/meow/prelude$.html","n":"Semigroup_Int","t":"given Semigroup_Int: given_Semigroup_Int","d":"meow/prelude$"},
{"l":"api/meow/prelude$.html","n":"Semigroup_Unit","t":"given Semigroup_Unit: given_Semigroup_Unit","d":"meow/prelude$"},
{"l":"api/meow/prelude$.html","n":"Monoid_String","t":"given Monoid_String: given_Monoid_String","d":"meow/prelude$"},
{"l":"api/meow/prelude$.html","n":"Monoid_Unit","t":"given Monoid_Unit: given_Monoid_Unit","d":"meow/prelude$"},
...
{"l":"api/meow/control/Monad$.html","n":"flatMap","t":"def flatMap[M[_]]: [A, B] => (f: A => M[B]) => Monad[M] => M[A] => M[B]","d":"meow/control/Monad$"},
...
{"l":"api/meow/control/trans/OptionT$$given_Functor_OptionT.html","n":"given_Functor_OptionT","t":"given given_Functor_OptionT[M[_]](using val functorM: Functor[M], val functorO: Functor[[A] =>> Option[A]]): Functor[[_] =>> OptionT[M, _$3]]","d":"meow/control/trans/OptionT$"},
...
{"l":"api/meow/control/trans/OptionT$$given_Functor_OptionT.html","n":"functorO","t":"val functorO: Functor[[A] =>> Option[A]]","d":"meow/control/trans/OptionT$"},
...
{"l":"api/meow/control/trans/OptionT$$given_Functor_OptionT.html","n":"given_Functor_OptionT","t":"given given_Functor_OptionT[M[_]](using val functorM: Functor[M], val functorO: Functor[[A] =>> Option[A]]): Functor[[_] =>> OptionT[M, _$3]]","d":"meow/control/trans/OptionT$$given_Functor_OptionT"},
...
{"l":"api/meow/control/trans/OptionT$$given_Functor_OptionT.html","n":"functorO","t":"val functorO: Functor[[A] =>> Option[A]]","d":"meow/control/trans/OptionT$$given_Functor_OptionT"},
...
{"l":"api/meow/control/trans/ReaderT$$given_Semigroup_ReaderT.html","n":"given_Semigroup_ReaderT","t":"given given_Semigroup_ReaderT[A, B, M[_]](`evidence$13`: Semigroup[B], `x$1`: Semigroup[M[B]]): Semigroup[(A, M) => B]","d":"meow/control/trans/ReaderT$"},
{"l":"api/meow/control/trans/ReaderT$$given_Semigroup_ReaderT.html","n":"`x$1`","t":"val `x$1`: Semigroup[M[B]]","d":"meow/control/trans/ReaderT$"},
{"l":"api/meow/control/trans/ReaderT$$given_Semigroup_ReaderT.html","n":"scombine","t":"def scombine(fx: ReaderT[A, M, B], fy: ReaderT[A, M, B]): ReaderT[A, M, B]","d":"meow/control/trans/ReaderT$"},
...
{"l":"api/meow/control/trans/ReaderT$$given_Semigroup_ReaderT.html","n":"given_Semigroup_ReaderT","t":"given given_Semigroup_ReaderT[A, B, M[_]](`evidence$13`: Semigroup[B], `x$1`: Semigroup[M[B]]): Semigroup[(A, M) => B]","d":"meow/control/trans/ReaderT$$given_Semigroup_ReaderT"},
{"l":"api/meow/control/trans/ReaderT$$given_Semigroup_ReaderT.html","n":"`x$1`","t":"val `x$1`: Semigroup[M[B]]","d":"meow/control/trans/ReaderT$$given_Semigroup_ReaderT"},
{"l":"api/meow/control/trans/ReaderT$$given_Semigroup_ReaderT.html","n":"scombine","t":"def scombine(fx: ReaderT[A, M, B], fy: ReaderT[A, M, B]): ReaderT[A, M, B]","d":"meow/control/trans/ReaderT$$given_Semigroup_ReaderT"},
...
{"l":"api/meow/data/Functor$.html","n":"map","t":"def map[F[_]]: [A, B] => (f: A => B) => Functor[F] => F[A] => F[B]","d":"meow/data/Functor$"},
...
{"l":"api/meow/data/Functor$$given_Functor_Const.html","n":"given_Functor_Const","t":"given given_Functor_Const[Y[_], Z]: Functor[Const[Y[Z]]]","d":"meow/data/Functor$"},
{"l":"api/meow/data/Functor$$given_Functor_Const.html","n":"fmap","t":"def fmap[A, B](f: A => B): Const[Y[Z]][A] => Const[Y[Z]][B]","d":"meow/data/Functor$"},
{"l":"api/meow/data/Functor$.html","n":"genFunctor","t":"given genFunctor","d":"meow/data/Functor$"},
{"l":"api/meow/data/Functor$.html","n":"derived","t":"def derived[F[_]](using m: K1[F]): Functor[F]","d":"meow/data/Functor$"},
...
{"l":"api/meow/data/Functor$$given_Functor_Const.html","n":"given_Functor_Const","t":"given given_Functor_Const[Y[_], Z]: Functor[Const[Y[Z]]]","d":"meow/data/Functor$$given_Functor_Const"},
{"l":"api/meow/data/Functor$$given_Functor_Const.html","n":"fmap","t":"def fmap[A, B](f: A => B): Const[Y[Z]][A] => Const[Y[Z]][B]","d":"meow/data/Functor$$given_Functor_Const"},
{"l":"api/meow/data/Monoid.html","n":"Monoid","t":"trait Monoid[A]","d":"meow/data/Monoid"},
{"l":"api/meow/data/Monoid.html","n":"mempty","t":"def mempty: A","d":"meow/data/Monoid"},
{"l":"api/meow/data/Monoid.html","n":"mconcat","t":"def mconcat(l: List[A]): A","d":"meow/data/Monoid"},
{"l":"api/meow/data/Monoid$.html","n":"Monoid","t":"object Monoid","d":"meow/data/Monoid$"},
{"l":"api/meow/data/Monoid$.html","n":"mempty","t":"def mempty[A](using m: Monoid[A]): A","d":"meow/data/Monoid$"},
{"l":"api/meow/data/Monoid$$given_Monoid_List.html","n":"given_Monoid_List","t":"given given_Monoid_List[A]: Monoid[List[A]]","d":"meow/data/Monoid$"},
{"l":"api/meow/data/Monoid$$given_Monoid_List.html","n":"mempty","t":"def mempty: List[A]","d":"meow/data/Monoid$"},
{"l":"api/meow/data/Monoid$$given_Monoid_Vector.html","n":"given_Monoid_Vector","t":"given given_Monoid_Vector[A]: Monoid[Vector[A]]","d":"meow/data/Monoid$"},
{"l":"api/meow/data/Monoid$$given_Monoid_Vector.html","n":"mempty","t":"def mempty: Vector[A]","d":"meow/data/Monoid$"},
{"l":"api/meow/data/Monoid$$given_Monoid_Unit$.html","n":"given_Monoid_Unit","t":"given given_Monoid_Unit: Monoid[Unit]","d":"meow/data/Monoid$"},
{"l":"api/meow/data/Monoid$$given_Monoid_Unit$.html","n":"mempty","t":"def mempty: Unit","d":"meow/data/Monoid$"},
{"l":"api/meow/data/Monoid$$given_Monoid_String$.html","n":"given_Monoid_String","t":"given given_Monoid_String: Monoid[String]","d":"meow/data/Monoid$"},
{"l":"api/meow/data/Monoid$$given_Monoid_String$.html","n":"mempty","t":"def mempty: String","d":"meow/data/Monoid$"},
{"l":"api/meow/data/Monoid$$given_Monoid_Option.html","n":"given_Monoid_Option","t":"given given_Monoid_Option[A]: Monoid[Option[A]]","d":"meow/data/Monoid$"},
{"l":"api/meow/data/Monoid$$given_Monoid_Option.html","n":"mempty","t":"def mempty: Option[A]","d":"meow/data/Monoid$"},
{"l":"api/meow/data/Monoid$.html","n":"derived","t":"given derived","d":"meow/data/Monoid$"},
{"l":"api/meow/data/Monoid$$given_Monoid_List.html","n":"given_Monoid_List","t":"given given_Monoid_List[A]: Monoid[List[A]]","d":"meow/data/Monoid$$given_Monoid_List"},
{"l":"api/meow/data/Monoid$$given_Monoid_List.html","n":"mempty","t":"def mempty: List[A]","d":"meow/data/Monoid$$given_Monoid_List"},
{"l":"api/meow/data/Monoid$$given_Monoid_Vector.html","n":"given_Monoid_Vector","t":"given given_Monoid_Vector[A]: Monoid[Vector[A]]","d":"meow/data/Monoid$$given_Monoid_Vector"},
{"l":"api/meow/data/Monoid$$given_Monoid_Vector.html","n":"mempty","t":"def mempty: Vector[A]","d":"meow/data/Monoid$$given_Monoid_Vector"},
{"l":"api/meow/data/Monoid$$given_Monoid_Unit$.html","n":"given_Monoid_Unit","t":"given given_Monoid_Unit: Monoid[Unit]","d":"meow/data/Monoid$$given_Monoid_Unit$"},
{"l":"api/meow/data/Monoid$$given_Monoid_Unit$.html","n":"mempty","t":"def mempty: Unit","d":"meow/data/Monoid$$given_Monoid_Unit$"},
{"l":"api/meow/data/Monoid$$given_Monoid_String$.html","n":"given_Monoid_String","t":"given given_Monoid_String: Monoid[String]","d":"meow/data/Monoid$$given_Monoid_String$"},
{"l":"api/meow/data/Monoid$$given_Monoid_String$.html","n":"mempty","t":"def mempty: String","d":"meow/data/Monoid$$given_Monoid_String$"},
{"l":"api/meow/data/Monoid$$given_Monoid_Option.html","n":"given_Monoid_Option","t":"given given_Monoid_Option[A]: Monoid[Option[A]]","d":"meow/data/Monoid$$given_Monoid_Option"},
{"l":"api/meow/data/Monoid$$given_Monoid_Option.html","n":"mempty","t":"def mempty: Option[A]","d":"meow/data/Monoid$$given_Monoid_Option"},
{"l":"api/meow/data/NonEmpty.html","n":"NonEmpty","t":"class NonEmpty[A](head: A, tail: List[A])","d":"meow/data/NonEmpty"},
{"l":"api/meow/data/NonEmpty$.html","n":"NonEmpty","t":"object NonEmpty","d":"meow/data/NonEmpty$"},
{"l":"api/meow/data/NonEmpty$.html","n":":|","t":"def :|[A](tail: List[A]): NonEmpty[A]","d":"meow/data/NonEmpty$"},
{"l":"api/meow/data/NonEmpty$.html","n":"`derived$Show`","t":"given `derived$Show`","d":"meow/data/NonEmpty$"},
{"l":"api/meow/data/NonEmpty$.html","n":"`derived$Functor`","t":"val `derived$Functor`: Functor[[A] =>> NonEmpty[A]]","d":"meow/data/NonEmpty$"},
{"l":"api/meow/data/Semigroup.html","n":"Semigroup","t":"trait Semigroup[A]","d":"meow/data/Semigroup"},
{"l":"api/meow/data/Semigroup.html","n":"scombine","t":"def scombine(x: A, y: A): A","d":"meow/data/Semigroup"},
{"l":"api/meow/data/Semigroup.html","n":"<>","t":"def <>(y: A): A","d":"meow/data/Semigroup"},
{"l":"api/meow/data/Semigroup.html","n":"sconcat","t":"def sconcat(nel: NonEmpty[A]): A","d":"meow/data/Semigroup"},
{"l":"api/meow/data/Semigroup$.html","n":"Semigroup","t":"object Semigroup","d":"meow/data/Semigroup$"},
{"l":"api/meow/data/Semigroup$.html","n":"scombine","t":"def scombine[A](x: A, y: A): Semigroup[A] => A","d":"meow/data/Semigroup$"},
{"l":"api/meow/data/Semigroup$.html","n":"sconcat","t":"def sconcat[A](nel: NonEmpty[A]): Semigroup[A] => A","d":"meow/data/Semigroup$"},
{"l":"api/meow/data/Semigroup$$given_Semigroup_List.html","n":"given_Semigroup_List","t":"given given_Semigroup_List[A]: Semigroup[List[A]]","d":"meow/data/Semigroup$"},
{"l":"api/meow/data/Semigroup$$given_Semigroup_List.html","n":"scombine","t":"def scombine(x: List[A], y: List[A]): List[A]","d":"meow/data/Semigroup$"},
{"l":"api/meow/data/Semigroup$$given_Semigroup_Int$.html","n":"given_Semigroup_Int","t":"given given_Semigroup_Int: Semigroup[Int]","d":"meow/data/Semigroup$"},
{"l":"api/meow/data/Semigroup$$given_Semigroup_Int$.html","n":"scombine","t":"def scombine(x: Int, y: Int): Int","d":"meow/data/Semigroup$"},
{"l":"api/meow/data/Semigroup$$given_Semigroup_Unit$.html","n":"given_Semigroup_Unit","t":"given given_Semigroup_Unit: Semigroup[Unit]","d":"meow/data/Semigroup$"},
{"l":"api/meow/data/Semigroup$$given_Semigroup_Unit$.html","n":"scombine","t":"def scombine(x: Unit, y: Unit): Unit","d":"meow/data/Semigroup$"},
{"l":"api/meow/data/Semigroup$$given_Semigroup_String$.html","n":"given_Semigroup_String","t":"given given_Semigroup_String: Semigroup[String]","d":"meow/data/Semigroup$"},
{"l":"api/meow/data/Semigroup$$given_Semigroup_String$.html","n":"scombine","t":"def scombine(x: String, y: String): String","d":"meow/data/Semigroup$"},
{"l":"api/meow/data/Semigroup$$given_Semigroup_Option.html","n":"given_Semigroup_Option","t":"given given_Semigroup_Option[A]: Semigroup[Option[A]]","d":"meow/data/Semigroup$"},
{"l":"api/meow/data/Semigroup$$given_Semigroup_Option.html","n":"scombine","t":"def scombine(x: Option[A], y: Option[A]): Option[A]","d":"meow/data/Semigroup$"},
{"l":"api/meow/data/Semigroup$$given_Semigroup_Vector.html","n":"given_Semigroup_Vector","t":"given given_Semigroup_Vector[A]: Semigroup[Vector[A]]","d":"meow/data/Semigroup$"},
{"l":"api/meow/data/Semigroup$$given_Semigroup_Vector.html","n":"scombine","t":"def scombine(x: Vector[A], y: Vector[A]): Vector[A]","d":"meow/data/Semigroup$"},
{"l":"api/meow/data/Semigroup$$given_Semigroup_Function.html","n":"given_Semigroup_Function","t":"given given_Semigroup_Function[A, B]: Semigroup[A => B]","d":"meow/data/Semigroup$"},
{"l":"api/meow/data/Semigroup$$given_Semigroup_Function.html","n":"scombine","t":"def scombine(fx: A => B, fy: A => B): A => B","d":"meow/data/Semigroup$"},
{"l":"api/meow/data/Semigroup$.html","n":"derived","t":"given derived","d":"meow/data/Semigroup$"},
{"l":"api/meow/data/Semigroup$$given_Semigroup_List.html","n":"given_Semigroup_List","t":"given given_Semigroup_List[A]: Semigroup[List[A]]","d":"meow/data/Semigroup$$given_Semigroup_List"},
{"l":"api/meow/data/Semigroup$$given_Semigroup_List.html","n":"scombine","t":"def scombine(x: List[A], y: List[A]): List[A]","d":"meow/data/Semigroup$$given_Semigroup_List"},
{"l":"api/meow/data/Semigroup$$given_Semigroup_Int$.html","n":"given_Semigroup_Int","t":"given given_Semigroup_Int: Semigroup[Int]","d":"meow/data/Semigroup$$given_Semigroup_Int$"},
{"l":"api/meow/data/Semigroup$$given_Semigroup_Int$.html","n":"scombine","t":"def scombine(x: Int, y: Int): Int","d":"meow/data/Semigroup$$given_Semigroup_Int$"},
{"l":"api/meow/data/Semigroup$$given_Semigroup_Unit$.html","n":"given_Semigroup_Unit","t":"given given_Semigroup_Unit: Semigroup[Unit]","d":"meow/data/Semigroup$$given_Semigroup_Unit$"},
{"l":"api/meow/data/Semigroup$$given_Semigroup_Unit$.html","n":"scombine","t":"def scombine(x: Unit, y: Unit): Unit","d":"meow/data/Semigroup$$given_Semigroup_Unit$"},
{"l":"api/meow/data/Semigroup$$given_Semigroup_String$.html","n":"given_Semigroup_String","t":"given given_Semigroup_String: Semigroup[String]","d":"meow/data/Semigroup$$given_Semigroup_String$"},
{"l":"api/meow/data/Semigroup$$given_Semigroup_String$.html","n":"scombine","t":"def scombine(x: String, y: String): String","d":"meow/data/Semigroup$$given_Semigroup_String$"},
{"l":"api/meow/data/Semigroup$$given_Semigroup_Option.html","n":"given_Semigroup_Option","t":"given given_Semigroup_Option[A]: Semigroup[Option[A]]","d":"meow/data/Semigroup$$given_Semigroup_Option"},
{"l":"api/meow/data/Semigroup$$given_Semigroup_Option.html","n":"scombine","t":"def scombine(x: Option[A], y: Option[A]): Option[A]","d":"meow/data/Semigroup$$given_Semigroup_Option"},
{"l":"api/meow/data/Semigroup$$given_Semigroup_Vector.html","n":"given_Semigroup_Vector","t":"given given_Semigroup_Vector[A]: Semigroup[Vector[A]]","d":"meow/data/Semigroup$$given_Semigroup_Vector"},
{"l":"api/meow/data/Semigroup$$given_Semigroup_Vector.html","n":"scombine","t":"def scombine(x: Vector[A], y: Vector[A]): Vector[A]","d":"meow/data/Semigroup$$given_Semigroup_Vector"},
{"l":"api/meow/data/Semigroup$$given_Semigroup_Function.html","n":"given_Semigroup_Function","t":"given given_Semigroup_Function[A, B]: Semigroup[A => B]","d":"meow/data/Semigroup$$given_Semigroup_Function"},
{"l":"api/meow/data/Semigroup$$given_Semigroup_Function.html","n":"scombine","t":"def scombine(fx: A => B, fy: A => B): A => B","d":"meow/data/Semigroup$$given_Semigroup_Function"},
{"l":"api/meow/generic.html","n":"meow.generic","t":"package meow.generic","d":"meow/generic"},
{"l":"api/meow/generic.html","n":"Const","t":"type Const[A] = [T] =>> A","d":"meow/generic"},
{"l":"api/meow/generic.html","n":"Id","t":"type Id[X] = X","d":"meow/generic"},
{"l":"api/meow/generic.html","n":"K1","t":"type K1[F[_]] = Mirror { type MirroredType = [X] =>> F[X]; type MirroredElemTypes <: ([_] =>> Tuple);  }","d":"meow/generic"},
{"l":"api/meow/generic.html","n":"K1Product","t":"type K1Product[F[_]] = Product { type MirroredType = [X] =>> F[X]; type MirroredElemTypes <: ([_] =>> Tuple);  }","d":"meow/generic"},
{"l":"api/meow/generic.html","n":"K1Sum","t":"type K1Sum[F[_]] = Sum { type MirroredType = [X] =>> F[X]; type MirroredElemTypes <: ([_] =>> Tuple);  }","d":"meow/generic"},
{"l":"api/meow/generic.html","n":"LiftP","t":"type LiftP[F[_[_]], T <: ([X] =>> Tuple)] = T[Any] match {\n  case a *: _ => F[[X] =>> Head[T[X]]] *: LiftP[F, [X] =>> Tail[T[X]]]\n  case _ => EmptyTuple\n}","d":"meow/generic"},
{"l":"api/meow/generic.html","n":"prodIterator","t":"def prodIterator[T](p: T): Iterator[Any]","d":"meow/generic"},
{"l":"api/meow/generic.html","n":"summonAsList","t":"def summonAsList[T <: Tuple, F[_]]: List[F[Any]]","d":"meow/generic"},
{"l":"api/meow/generic.html","n":"summonKindAsList","t":"def summonKindAsList[T <: Tuple, K[_[_]]]: List[K[[X] =>> Any]]","d":"meow/generic"}];